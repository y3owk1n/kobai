...
function SelectContent({
  ...
  return (
    ...
    // every landmark, and `axe-core` fails the build on the options as `region` the moment a
    // browser case audits a screen with this open. The container comes from the frame
    // (`@/lib/portal.tsx`), which renders it inside `main`; `undefined` where there is no frame,
    // which is upstream's behaviour exactly.
    <SelectPrimitive.Portal container={container ?? fromTheFrame}>
